...
class SmartCart extends HTMLElement {
  ...
  createLoginScreen() {
    ...
    collapsibleText.innerHTML = '<span>Sign in for the best experience! Here\'s what you\'re missing out on:<br><br><b>⏳ Reserved Products:</b> Items you add to your cart are reserved for you, giving you a head start on the chase for hot items.<br><b>🔄 Shop on the Go:</b> Start your shopping on one device and finish on another. Your cart follows you everywhere, on any device.<br><b>⚡ Express Checkout:</b> Save your shipping details to breeze through checkout. Shopping made quicker than ever!<br><b>🔒 Safe and Secure:</b> Shop with peace of mind knowing your data and transactions are protected with top-notch security.<br><b>🖥️ Track Your Orders:</b> Stay in the loop with real-time updates on your orders.<br><br>Sign in, or create an account now!</span>';
